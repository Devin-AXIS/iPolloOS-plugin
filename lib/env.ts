...
export const env = createEnv({
  ...
  server: {
    ...
    IPOLLOOS_BASE_URL: z.url().default('http://localhost:3000'),
    ...
    MONGODB_URI: z
      ...
      .nonempty()
      .default(
        'mongodb://username:password@localhost:27017/ipolloos?authSource=admin&directConnection=true'
      ),
    ...
    LOG_OTEL_SERVICE_NAME: z.string().default('iPolloOS-plugin'),
    ...
    STORAGE_PUBLIC_BUCKET: z.string().default('ipolloos-public'),
    STORAGE_PRIVATE_BUCKET: z.string().default('ipolloos-private'),
