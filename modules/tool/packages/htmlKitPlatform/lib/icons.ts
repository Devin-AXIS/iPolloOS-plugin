/**
 * 内置单色 SVG（stroke/fill=currentColor），宽高由外层 style 控制。
 */
...
export const PRESET_ICONS: Record<string, string> = {
  ...
  cross: stroke('<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'),
  menu: stroke('<path d="M4 5h16"/><path d="M4 12h16"/><path d="M4 19h16"/>'),
  ...
  sparkles: stroke(
    '<path d="m12 3-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3L12 3Z"/><path d="M5 3v4"/><path d="M9 3v2"/><path d="M3 5h4"/><path d="M3 9h2"/>'
  ),
  'chart-bar': stroke(
