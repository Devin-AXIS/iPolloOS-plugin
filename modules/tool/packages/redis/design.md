...
本文档详细描述如何在 iPolloOS Plugin 系统中开发一个 Redis 缓存工具集。该工具集包含 3 个子工具,共享统一的 Redis 连接配置,提供简洁的缓存操作能力。
...
```json
{
  "name": "@tool/redis",
  "version": "0.1.0",
  "description": "Redis cache toolset for iPolloOS Plugin",
  "main": "index.ts",
  "scripts": {
    "test": "vitest"
  },
...
在 iPolloOS 中首次使用时,只需配置一次 Redis 连接串:
