  ...
  versionList: [
    {
      value: '1.2.17',
      description:
        'Publish upstream-AI-generated single-file HTML while preserving template-family routing, publication TOC runtime, slide controls, PDF export, and gallery metadata',
      inputs: [
        {
          key: 'template_id',
          label: '模板选择',
