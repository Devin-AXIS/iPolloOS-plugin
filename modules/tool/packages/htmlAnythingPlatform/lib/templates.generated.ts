...
export type HtmlAnythingTemplate = {
  id: string;
  zhName: string;
  enName: string;
  emoji: string;
...
export const HTML_ANYTHING_TEMPLATES = [
  {
    id: 'article-magazine',
    zhName: '杂志文章',
  ...
  },
  {
    ...
    zhName: 'Hyperframes 视频脚本',
    enName: 'Hyperframes Video',
    emoji: '🎞️',
    description: '适配 Hyperframes / Remotion 的连续帧动画, 可自动播放',
    category: 'video',
    scenario: 'video',
    aspectHint: '1920×1080 (16:9)',
    recommended: 5,
...
] as const satisfies readonly HtmlAnythingTemplate[];

export const HTML_ANYTHING_TEMPLATE_IDS = HTML_ANYTHING_TEMPLATES.map((item) => item.id);
