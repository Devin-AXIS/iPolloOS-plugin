...
export default defineTool({
  name: {
    'zh-CN': 'HappyHorse 文生视频',
    en: 'HappyHorse Text-to-Video'
  },
  description: {
    'zh-CN': '使用阿里云百炼 HappyHorse 1.0，根据文本提示词异步生成视频。',
    en: 'Generate videos from text prompts with Alibaba Cloud Model Studio HappyHorse 1.0.'
  },
  versionList: [
    {
      value: '0.1.0',
      description: '接入 happyhorse-1.0-t2v 异步文生视频',
      inputs: [
        {
          key: 'prompt',
          label: '提示词',
          description: '描述期望生成的视频内容，支持中英文。',
          toolDescription: 'Text prompt for the video. Required.',
