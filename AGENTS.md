...
iPolloOS 插件系统是一个基于 monorepo 架构的插件开发平台，支持开发和部署各种 iPolloOS 工具和工作流组件。
...
/modules/tool/packages/testPR/*
/Volumes/Code/iPolloOS-plugins/modules/tool/packages/sparseTool
/modules/tool/packages/testTool
```
...
3. **创建 iPolloOS 配置**：根据工具类型创建对应的 manifest.json 和工具集配置
