...
import { iPolloOSPluginClient, RunToolWithStream } from './client';
import type { SystemVarType } from './client';

const baseUrl = import.meta.env.IPOLLOOS_PLUGIN_BASE_URL!;
const token = import.meta.env.IPOLLOOS_PLUGIN_TOKEN!;

const client = new iPolloOSPluginClient({ baseUrl, token });
